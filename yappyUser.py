...
class YappyUser:
    ...
    def get_active_users():
        return list(filter(lambda user: (datetime.datetime.now() - user.last_login_time).total_seconds()/60/60 <= config._settings.get('active_users_hours',default=3.0/10.0),
